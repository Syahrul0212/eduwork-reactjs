              ...
              <div className="w-full h-full bg-primaryColor bg-opacity-40 absolute top-0 left-0 z-[5] hidden group-hover:block">
                <div className="w-full h-full flex items-center justify-center">
                  <button
                    ...
                    className="text-white bg-headingColor hover:bg-smallTextColor ease-in duration-300 py-2 px-4 rounded-[8px] font-[500]"
                  >
                    See Details
                  </button>
                </div>
        ...
        <div className="text-center mt-6">
          {nextItems < portfolios.length && data.length > 6 && (
            <button
              ...
              className="text-white bg-primaryColor hover:bg-smallTextColor ease-in duration-300 py-2 px-4 rounded-[8px] font-[500]"
            >
              Load More
            </button>
          )}
